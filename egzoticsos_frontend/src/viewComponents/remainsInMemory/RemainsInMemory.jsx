...
export default function RemainsInMemory() {
  ...
  useEffect(() => {
    const category = "Liks atmintį";
    fetch(
      `https://www.egzoticsos.nyxie.lt/getDataWithCategory.php?category=${encodeURIComponent(
        category
      )}`,
      {
        method: "GET",
      ...
      <div className="allAnimalsHeader">
        <div className="innerWrapper">
          <div className="allAnimalsHeaderLeftSide">
            ...
            <p>
              Pritaikyti filtrai:{" "}
              <span className="animalFilter">Liks atminty</span>
