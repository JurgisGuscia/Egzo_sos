...
export default function AnimalSearch({ state }) {
  ...
  useEffect(() => {
    fetch(
      `https://www.egzoticsos.nyxie.lt/searchForAnimals.php?mark=${searchObject.mark}&breed=${searchObject.breed}&category=${searchObject.category}&gender=${searchObject.gender}`,
      {
        method: "GET",
        headers: {
  ...
  }, [searchObject.mark, searchObject.category, searchObject.gender]);
  ...
  return (
    <div className="animalSearchPage">
      <NavBar />
      <div className="allAnimalsHeader">
        <div className="innerWrapper">
          <div className="allAnimalsHeaderLeftSide">
            ...
            <p>
              Pritaikyti filtrai:
              <span className="animalFilter">Klasė: {searchObject.mark}</span>
              <span className="animalFilter">Rūšis: {searchObject.breed}</span>
              <span className="animalFilter">
                Kategorija: {searchObject.category}
              </span>
              <span className="animalFilter">Lytis: {searchObject.gender}</span>
            </p>
          </div>
          <div className="allAnimalsHeaderRightSide">
            <p>Rikiuoti pagal: </p>
            <div className="orderLogic">Naujausi viršuje</div>
          </div>
        </div>
      </div>
      <div className="animalCardDisplayContainer">
        <div className="innerWrapper">
          {subDisplay.length > 0 ? (
            ...
            <h2>
              Pagal nurodytus paieškos kriterijus, dovanojamų arba globojamų
              gyvūnų nerasta.
            </h2>
          )}
        </div>
