...
export default function UnderCare() {
  ...
  useEffect(() => {
    fetch(
      `https://www.egzoticsos.nyxie.lt/getDataWithCategory.php?category=Globojami`,
      {
        method: "GET",
        headers: {
      ...
      <div className="allAnimalsHeader">
        <div className="innerWrapper">
          <div className="allAnimalsHeaderLeftSide">
            ...
            <p>
              Pritaikyti filtrai:{" "}
              <span className="animalFilter">Globojami</span>
